...
// Depois da correção
const dessert = `
${dogNames[0].slice(3, 5) + dogNames[1].slice(2, 5) + dogNames[3].slice(2, 5)}
`.replace("n", "d");
console.log(
  `
...
// antes da correção
// const dessertReplace = dessert.replace("n", "d");
// console.log(dessertReplace);
